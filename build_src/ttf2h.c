// Build "script" that loads fonts and converts them into a ./build/fonts.h file
...
void generate_font(FILE *file, const char *name, const char *path, int base_size) {
	...
	fprintf(file, "#ifdef FONTS_IMPLEMENTATION\n");
...
int main() {
	FILE *output_file = fopen("./build/fonts.h", "w");
	fprintf(
		output_file,
